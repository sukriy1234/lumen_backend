...
class OrderController extends Controller
{
    ...
    public function view(Request $request)
    {
        ...
        return($this->order_service->view($request->header('api_token'), $id));
    }
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
			...
			return $this->order_service->store($request->product, $request->concierge_fee, $request->header('api_token'), $request->duedate, $request->reporter);
		}
    }
	...
	public function update_finance(Request $request){
        ...
        if ($validator->fails()) {
			...
			return $this->order_service->update_finance($request->product, $request->concierge_fee, $request->id, $request->payment, $request->header('api_token'));
		}
	}
}
